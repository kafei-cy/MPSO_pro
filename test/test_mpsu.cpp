...
void MPSU_test(u32 idx, u32 numElements, u32 numParties, u32 numThreads){
    ...
    if (idx == 0){
        ...
        out = mpso::proto::runMpsu(idx, numParties, numElements, set, numThreads);
        ...
        mpso::proto::runMpsu(idx, numParties, numElements, set, numThreads);
    }
    return ;
}
...
int main(int agrc, char** argv){
    ...
    if (preGen){
        mpso::preproc::generateMpsuOffline({idx, k, nn, nt});
    } 
