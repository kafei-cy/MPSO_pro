...
void MPSICrad_test(u32 idx, u32 numElements, u32 numParties, u32 numThreads){
    ...
    if (idx == 0){   
        u32 outSize = mpso::proto::runMpsic(idx, numParties, numElements, set, numThreads);
        ...
        mpso::proto::runMpsic(idx, numParties, numElements, set, numThreads);
    }
    return ;
}
...
int main(int agrc, char** argv){
    ...
    if (preGen){
        mpso::preproc::generateMpsicOffline({idx, k, nn, nt});
    } 
